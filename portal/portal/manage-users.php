...
if (isset($_POST['update'])) {
    ...
    try {
        ...
        if ($query) {
            header("Location: manage-users?id=$update_id&status=edit&message=success");
        }
...
if (isset($_POST['del'])) {
    $del = $_POST["id"];
    $query = DB::delete('users', "id=%i", $del);

    if ($query) {
        header('location: manage-users?message=deleted');
    }
}
...
if (isset($_POST['save'])) {
    ...
    try {
        ...
        if ($query) {
            header("Location: manage-users?message=added");
        }
    } catch (MeekroDBException $e) {
        $error = $e->getMessage();
        echo "    <script>  
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                <center>
                                                    ...
                                                    <input required type="text"
                                                           value="<? echo $user["first_name"] ?>" name="first_name"
                                                           class="form-control"
                                            ...
                                            <div class="form-group">
                                                <center>
                                                    ...
                                                    <input required type="text"
                                                           value="<? echo $user["last_name"] ?>" name="last_name"
                                                           class="form-control"
                                            ...
                                            <div class="form-group">
                                                <center>
                                                    ...
                                                    <input type="password"
                                                           value="<? echo $user["password"] ?>" name="password"
                                                           class="form-control"
                                            ...
                                            <div class="form-group">
                                                <center>
                                                    ...
                                                    <select required class="form-control" name="role">
                                                        ...
                                                        <option <? if($user['role']=='portal'){?>selected<?}?> value="admin">Administrator</option>
                                                        <option <? if($user['role']=='doctor'){?>selected<?}?> value="doctor">Doctor</option>
                                                        <option <? if($user['role']=='nurse'){?>selected<?}?> value="nurse">Nurse</option>
                                                    </select>
                                                </center>
                                            </div>
                                        </div>
                                ...
                                <div class="card card-custom">
                                    ...
                                    <div class="card-body">
                                        <table class="datatable datatable-bordered datatable-head-custom"
                                            ...
                                            <tbody>
                                            <?
                                            $query = DB::query("SELECT * FROM users order by first_name ASC");
                                            foreach ($query
                                                     as $row):
                                                ...
                                                <tr>
                                                    ...
                                                    <td><? echo $row['role'] ?></td>
                                                    <td>
                                                        <a href="manage-users?id=<?php echo $row['id'] ?>&status=edit"
