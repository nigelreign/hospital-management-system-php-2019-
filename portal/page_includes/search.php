...
<div class="card card-custom gutter-b">
    <div class="card-body d-flex align-items-center py-10 py-lg-10">
        <div class="m-0 text-dark-50 font-weight-bold font-size-lg col-md-6">
            <div class="form-group">
                <label><b>Search For A Subject</b></label>
                <input type="text" name="search" class="form-control" placeholder="Search...." />
            </div>
        </div>
        <input type="submit" class="btn btn-sm btn-primary font-weight-bolder px-6" value="Search"/>
    </div>
    <div style="margin-top: -60px" class="card-body d-flex align-items-center">
        <div class="d-flex align-items-center flex-lg-fill mr-5 my-1">
            ...
            <div class="d-flex flex-column text-dark-75">
                <a href="./" class="font-weight-bolder font-size-sm">View all subject</a>
            </div>
        </div>
    </div>
